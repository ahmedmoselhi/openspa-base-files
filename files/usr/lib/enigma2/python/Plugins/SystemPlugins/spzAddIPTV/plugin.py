...
if esHD():
    skin = '\n\t<screen position="340,150" size="975,660" title="">\n\t\t<widget name="menu" position="15,7" size="945,500" scrollbarMode="showOnDemand" />\n\t\t<widget source="statusbar" render="Label" position="15,510" zPosition="10" size="945,75" halign="center" valign="center" font="Regular;18" foregroundColor="#666666" transparent="1" shadowColor="black" shadowOffset="-1,-1" />\n\t\t<ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/spazeMenu/imgvk/hdredcor.png" position="15,577" size="225,60" alphatest="blend" />\n\t\t<ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/spazeMenu/imgvk/hdgreencor.png" position="255,577" size="225,60" alphatest="blend" />\n\t\t<ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/spazeMenu/imgvk/hdyellowcor.png" position="495,577" size="225,60" alphatest="blend" />\n\t\t<ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/spazeMenu/imgvk/hdbluecor.png" position="735,577" size="225,60" alphatest="blend" />\n\t\t<widget source="key_red" render="Label" position="15,577" zPosition="1" size="225,67" font="Regular;20" halign="center" valign="center" transparent="1" />\n\t\t<widget source="key_green" render="Label" position="255,577" zPosition="1" size="225,67" font="Regular;20" halign="center" valign="center" transparent="1" />\n\t\t<widget source="key_yellow" render="Label" position="495,577" zPosition="1" size="225,67" font="Regular;20" halign="center" valign="center" transparent="1" />\n\t\t<widget source="key_blue" render="Label" position="735,577" zPosition="1" size="225,67" font="Regular;20" halign="center" valign="center" transparent="1" />\n\t\t</screen>'
else:
...
def m3ulistentry(name, url, select = False, append = False):
    ...
    res.append(MultiContentEntryText(pos=(fhd(30, 1.6), fhd(22)), size=(fhd(600), fhd(30)), font=1, text=url, color=6710886))
    return res
...
class liveStreamingFromFile(Screen):
    ...
    def __init__(self, session, bouquet):
        ...
        self['actions'] = ActionMap(['SetupActions', 'ColorActions', 'MediaPlayerActions'], {'ok': self.keyOk,
         'save': self.keyOk,
    ...
    def addServiceToBouquet(self, service = None):
