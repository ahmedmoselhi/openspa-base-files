...
def channels_list():
   ...
   #itemlist.append( Item( title="RojaDirecta"             , channel="rojadirecta"        , language="ES" , category="T"   , type="generic" ))
    ...
    #itemlist.append( Item( title="Series Pepito"             , channel="seriespepito"             , language="ES" , category="V"        , type="generic"  ))
    #itemlist.append( Item( title="Peliculas Pepito"             , channel="peliculaspepito"             , language="ES" , category="V"        , type="generic"  ))
    itemlist.append( Item( title="Series Yonkis"             , channel="seriesyonkis"             , language="ES" , category="V"        , type="generic"  ))
    itemlist.append( Item( title="Series Adicto"             , channel="seriesadicto"             , language="ES" , category="V"        , type="generic"  ))
    #itemlist.append( Item( title="Seriesflv"             , channel="seriesflv"             , language="ES" , category="V"        , type="generic"  ))
    itemlist.append( Item( title="Yaske"             , channel="yaske"             , language="ES" , category="V"        , type="generic"  ))
    itemlist.append( Item( title="Oranline"             , channel="oranline"             , language="ES" , category="V"        , type="generic"  ))
    ...
    itemlist.append( Item( title="Cinehanwer"             , channel="cinehanwer"             , language="ES" , category="V"        , type="generic"  ))
    #itemlist.append( Item( title="NewHD"             , channel="newhd"             , language="ES" , category="V"        , type="generic"  ))
    #itemlist.append( Item( title="MegaHD"             , channel="megahd"             , language="ES" , category="V"        , type="generic"  ))
    #itemlist.append( Item( title="MegaSpain"             , channel="megaspain"             , language="ES" , category="V"        , type="generic"  ))
    ...
    itemlist.append( Item( title="HdFull"             , channel="hdfull"             , language="ES" , category="V"        , type="generic"  ))
    itemlist.append( Item( title="Teledocumentales"           , channel="teledocumentales"          , language="ES"    , category="T"       , type="generic"  ))
...
#    if config.plugins.TVweb.showadultcontent.value == True: itemlist.append( Item( title="PeliculasEroticas"          , channel="peliculaseroticas"             , language="ES" , category="X" , type="generic"  ))
    ...
    if config.plugins.TVweb.showadultcontent.value == True: itemlist.append( Item( title="Serviporno"          , channel="serviporno"             , language="ES" , category="X" , type="generic"  ))
