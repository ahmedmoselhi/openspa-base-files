...
def play(item):
    ...
    #logger.debug(data)
    #            video: {
    #                file: 'http://9.xhcdn.com/key=BxL.CAL3w0U,end=1444175238/data=A8B26D73/speed=500k/initial_buffer=702787/3163969_hd.mp4',
    #                thumb: 'http://et05.xhcdn.com/t/969/320/7_3163969.jpg'
    #            },

    url = scrapertools.get_match(data,"video: {[^f]+file: '([^']+)',")
